...
This script considers reductions in transmission on mainland Tanzania
...
df_int = pd.read_csv('interventions_betared_mainland.csv')
...
beta_red_islands = df_int['beta_red_islands'][run_number]
beta_red_mainland = df_int['beta_red_mainland'][run_number]
...
beta_new = np.zeros((3))
beta_new[0:2] = beta[0:2]*(1-beta_red_islands)
beta_new[2] = beta[2]*(1-beta_red_mainland)
...
chdir('../outputs/betared_mainland')
